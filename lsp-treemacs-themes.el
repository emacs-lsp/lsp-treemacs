...
(treemacs-modify-theme "Default"
  ...
  (progn
    ...
    (treemacs-create-icon :file "symbol-enumerator-member.png" :extensions (enumerator-member) :fallback "-")
    (treemacs-create-icon :file "symbol-enumerator.png" :extensions (enumerator) :fallback "-")
